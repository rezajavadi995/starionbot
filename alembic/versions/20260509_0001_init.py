...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_ledger_transactions_user_id", "ledger_transactions", ["user_id"], unique=False
    )
    op.create_index(
        "ix_ledger_transactions_wallet_id", "ledger_transactions", ["wallet_id"], unique=False
    )
    op.create_index(
        "ix_ledger_transactions_tx_type", "ledger_transactions", ["tx_type"], unique=False
    )
    op.create_index(
        "ix_ledger_transactions_idempotency_key",
        "ledger_transactions",
        ["idempotency_key"],
        unique=True,
    )
